...
class LoadInterface(Interface):
    ...
    async def set_level(self, contractor_number: int, level: float | Decimal) -> None:
    ...
    async def get_level(self, contractor_number: int) -> Decimal:
        ...
        # -> <level>
        return await self.invoke(contractor_number, "VGL", as_type=Decimal)
    ...
    async def turn_on(
            self, contractor_number: int, transition: float | None = None, level: float | None = None
    ) -> None:
    ...
    async def turn_off(self, contractor_number: int, transition: float | None = None) -> None:
