...
from aiovantage_qlink.command_client import CommandClient
from aiovantage_qlink.command_client.utils import (
    ParameterType,
    encode_params,
    parse_param,
    tokenize_response,
...
class Interface:
    ...
    @overload
    async def invoke(self, contractor_number: int, method: str, *params: ParameterType) -> Any: ...

    @overload
    async def invoke(
        self, contractor_number: int, method: str, *params: ParameterType, as_type: type[T]
    ) -> T: ...
    ...
    async def invoke(
        ...
        *params: ParameterType,
        ...
        Args:
            contractor_number: The contractor_number of the object to invoke the command on.
        ...
        # Send the request
        raw_response = await self.command_client.raw_request(request, *params)

        # Break the response into tokens
        result, *args = tokenize_response(raw_response[0])
